        ...
        <div className="container-wide">
          ...
          <div className="mb-16">
            ...
            >
              ...
              >
                <span className="text-[clamp(2.5rem,12vw,10rem)] font-[family-name:var(--font-syne)] font-bold text-[var(--color-text-primary)] leading-[0.9] tracking-[-0.04em] hover:opacity-40 transition-opacity duration-500">
                  Let's talk
          ...
          <RevealOnScroll delay={0.3}>
            <div className="flex flex-wrap gap-6">
              {socialLinks.map((link, index) => (
                ...
                >
                  <link.icon
                    className="size-5 text-[var(--color-text-muted)] group-hover:text-[var(--color-text-primary)] transition-colors"
                    strokeWidth={1.5}
                  />
